const queries = {
  users: `
        ...
        shortlisted_count NUMERIC DEFAULT 0 CHECK (shortlisted_count >= 0),
        contacted_count NUMERIC DEFAULT 0 CHECK (contacted_count >= 0),
        forgot_password_hash VARCHAR (255),
        shortlisted_houses VARCHAR [],
        shortlisted_pgs VARCHAR [],
        count_shortlists NUMERIC DEFAULT 0,
